...
DISCORD_BROWSER_MIN_AVAILABLE_MEMORY_MB = 256
DISCORD_BROWSER_MEMORY_CHECK_INTERVAL_SECONDS = 10
# 防止刚启动、打开频道时的短时内存峰值造成连续重建。
DISCORD_BROWSER_MEMORY_RECYCLE_MIN_AGE_SECONDS = 300
...
WEBSOCKET_CHANNEL_ROTATE_INTERVAL = 5.0  # websocket 模式单页面轮转频道间隔；设为 0 可固定在首个频道
